<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
    <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
        <div class="text-dark order-2 order-md-1">
            ...
            • <font style="font-size: 110%;">Copyright &copy; 2013-<script type="text/javascript" language=“JavaScript“>
                    var aktuellesDatum = new Date();
                    var Jahr = aktuellesDatum.getFullYear();
                    document.write(Jahr);
                </script>
                <a href="" class="text-dark-75 text-hover-primary"><?= env('APP_NAME_SECOND'); ?></a></font>
        </div>
        <div class="nav nav-dark">
            <a target="_blank" href="<?= $helper->url(); ?>agb" class="nav-link pl-0 pr-5">AGB</a>
            <a target="_blank" href="<?= $helper->url(); ?>legal/withdrawal/" class="nav-link pl-0 pr-5">Wiederrufsrecht</a>
...
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
    <div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
        ...
        <small class="text-muted font-size-sm ml-2">Kunden-ID (<?= env('CUSTOMER_ID') ?>-<?= $user->getDataById($userid, 'id'); ?>)</small></h3>
    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <form method="post">
            <div class="row noselect">
                ...
                <label class="col-9 col-form-label">
                    <span class="svg-icon svg-icon-primary svg-icon-2x">
                        <img src="<?= env('URL') ?>assets/images/germany.png" alt="" width="20" height="20">
                        <!--
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <rect x="0" y="0" width="24" height="24"/>
                ...
                <div class="col-3">
                    <span class="checkbox-inline">
                        <label class="checkbox checkbox-lg">
                            <input type="checkbox" <?php if($user->getDataById($userid,'germanmode')){ echo 'checked="checked"'; } ?> name="germanmode"/>
                            <span></span>
                        </label>
                    </span>
                </div>
