                ...
                <div class="d-flex">
                    ...
                    <div class="me-n2">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                            ...
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <?php if($user->isPartner($_COOKIE['session_token'])) { ?>
                                ...
                                <div class="menu-item px-5">
                                    <a href="" class="menu-link px-5">
                                        ...
                                        <span class="menu-badge">
                                            <span class="badge badge-light-info badge-circle fw-bolder fs-7">
                                                0
                                            </span>
                                        </span>
                                    </a>
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 menu-active-bg" id="#kt_aside_menu" data-kt-menu="true">
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    <span class="menu-link">
                        ...
                        <span class="menu-title">LXC V-Server</span>
                        <span class="menu-arrow"></span>
                    </span>

                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link <?php if($helper->protect($_GET['page']) == 'p_vserver_order') { echo 'active'; } else { echo ''; } ?>" href="<?= env('URL') . 'order/vserver/'; ?>">
                        ...
                        if($SQL->rowCount() != 0) { ?>
                            ...
                            <div class="menu-item">
                                <a class="menu-link <?php if($helper->protect($_GET['page']) == 'vserver_index' || $helper->protect($_GET['page']) == 'vserver_manage' || $helper->protect($_GET['page']) == 'vserver_renew' || $helper->protect($_GET['page']) == 'vserver_reconfigure') { echo 'active'; } else { echo ''; } ?>" href="<?= env('URL') . 'index/vserver/'; ?>">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                ...
                <?php if($user->isAdmin($_COOKIE['session_token'])){ ?>
                    ...
                    <div class="menu-item">
                        <a class="menu-link <?php if($helper->protect($_GET['page']) == 'team_system') { echo 'active'; } else { echo ''; } ?>" href="<?= env('URL') . 'team/system/'; ?>">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
                            <span class="svg-icon svg-icon-2">
                                    <!--begin::Svg Icon | path: assets/media/icons/duotune/communication/com010.svg-->
                            ...
                            <span class="menu-title">Systemverwaltung</span>
                        </a>
                    </div>

                    <div class="menu-item">
                        <a class="menu-link <?php if($helper->protect($_GET['page']) == 'team_transactions') { echo 'active'; } else { echo ''; } ?>" href="<?= env('URL') . 'team/transactions/'; ?>">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
                            <span class="svg-icon svg-icon-2">
                                    <!--begin::Svg Icon | path: assets/media/icons/duotune/communication/com010.svg-->
                    ...
                    <div class="menu-item">
                        <a class="menu-link <?php if($helper->protect($_GET['page']) == 'team_spin_login') { echo 'active'; } else { echo ''; } ?>" href="<?= env('URL') . 'team/spin_login/'; ?>">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
                            <span class="svg-icon svg-icon-2">
                                    <!--begin::Svg Icon | path: assets/media/icons/duotune/communication/com010.svg-->
                            ...
                            <span class="menu-title">Support-PIN Login</span>
                        </a>
                    </div>
