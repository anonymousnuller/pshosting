...
$currPage = 'customer_KVM-Rootserver bestellen';
include BASE_PATH . 'software/controller/PageController.php';

include BASE_PATH . 'software/managing/customer/rootserver/order.php';
            ...
            <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="card">
                                <div class="card-header">
                                    <h1 class="card-title">Prepaid KVM-Rootserver</h1>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-6">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <select class="form-select form-select-solid" tabindex="-1" data-control="select2" data-placeholder="Wähle deine Kerne aus." data-allow-clear="1" id="cores" name="cores">
                                                    <?php
                                                    $SQL = $db->prepare("SELECT * FROM `kvm_servers_option_entries` WHERE `option_id` = :option_id");
                        ...
                        <script>
                            ...
                            function update()
                            {
                                ...
                                var ground = <?= $site->getProductPrice('AMD_ROOTSERVER'); ?>;
                ...
                <?php } elseif(isset($_POST['step2_packs'])) { include BASE_PATH . 'software/managing/customer/rootserver/hosterapi/order_packs.php'; ?>
                    ...
                    <div class="row">
                        ...
                        <?php
                        $SQL = $db->prepare("SELECT * FROM `kvm_servers_packs` WHERE `type` = :type");
