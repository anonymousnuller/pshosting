...
if(is_null($user->getDataById($userid, 'support_pin'))) {
    if(empty($user->getDataById($userid, 'support_pin'))) {
        ...
        <div id="kt_content_container" class="container-xxl">
            <div class="container">
                <div class="row">
                    ...
                    <h4 class="iq-title">
                        <span id="welcome" class="fs-1 fw-bolder"></span>
                    </h4>

                    <p class="iq-title-desc">
                        Aufgrund der noch herrschenden Corona-Pandemie, wünschen wir dir alles gute und bleib gesund.
                    </p>
                                        ...
                                        <div class="d-flex align-items-center flex-grow-1">
                                            ...
                                            <?php } else { ?>
                                                ...
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <span class="text-gray-400 fw-bold">Posted by <?= env('APP_NAME'); ?> Internal-API</span>
                                                </div>
                                                <!--end::Info-->
                                            <?php } ?>
                                        </div>
