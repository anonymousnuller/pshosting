<?php
$currPage = 'front_KVM Root-Server konfigurieren';
                    ...
                    <div class="card shadow mb-5">
                        <div class="card-header"><h1>Prepaid KVM Rootserver</h1>
                            ...
                            <div class="alert alert-primary" role="alert">
                                ...
                                <p>KVM Root-Server nur für kurze Zeit ab <b>3.00€</b></p>

                                <hr>
                                <p class="mb-0">Das Angebot gilt noch bis zum 11.06.2022 - 23:59 Uhr.</p>
                            </div>
                            <hr>
                        ...
                        </svg><!--end::Svg Icon--></span> bis zu <b>16</b> Kerne (Max. 4,00 Ghz) <i class="fas fa-check text-success"></i><br>
                        ...
                        </svg><!--end::Svg Icon--></span> bis zu <b>250</b> GB SSD Speicher	<i class="fas fa-check text-success"></i><br>
                        ...
                        </svg><!--end::Svg Icon--></span> Standort Skylink (NL) <i class="fas fa-check text-success"></i><br>
                        ...
                        </svg><!--end::Svg Icon--></span> 10 Gbit/s Uplink <i class="fas fa-check text-success"></i><br>
                        ...
                        </svg><!--end::Svg Icon--></span> DDoS-Protection <i class="fas fa-check text-success"></i><br>
                ...
                <div class="col-md-3">
                    <div class="card shadow mb-5">
                        ...
                        <div class="card-body">
                            ...
                            <br>
                            <?php if($user->sessionExists($_COOKIE['session_token'])){ ?>
                                <a href="#" onclick="orderNow();" id="orderBtn" class="btn btn-block btn-outline-primary mb-4">
