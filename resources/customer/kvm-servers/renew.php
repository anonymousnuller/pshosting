<?php
$currPage = 'customer_KVM Rootserver verlängern';
include BASE_PATH . 'software/controller/PageController.php';
include BASE_PATH . 'software/managing/customer/rootserver/renew.php';
?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="post">
                                    ...
                                    <select id="duration" name="duration" class="form-control form-control-solid">
