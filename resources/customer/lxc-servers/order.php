        ...
        <div class="container">
            <div class="row justify-content-center">
                    ...
                    <div class="card shadow mb-5">
                        <div class="card-body" style="text-align: center;">
                            ...
                            <span style="font-size: 110%;">
                                ...
                                <a href="<?= $helper->url(); ?>order/vserver/custom" class="btn btn-block btn-outline-primary mb-4">
                    ...
                    <div class="card shadow mb-5">
                        <div class="card-body" style="text-align: center;">
                            ...
                            <span style="font-size: 110%;">
                                ...
                                <a href="<?= $helper->url(); ?>order/vserver/packs" class="btn btn-block btn-outline-primary mb-4">
                ...
                <div class="col-md-3">
                    ...
                    <div class="row" style="text-align: center;">
                        <div class="col-12">
                            <div class="alert" style="background-color: #dc3545;" role="alert">
                                <h2>Ausverkauft</h2> <hr>
                                <p>Die OVH Game LXC V-Server sind momentan nicht erhältlich. Wir sind bereits an der Nachschaffung.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row" style="text-align: center;">
                    <div class="col-12">
                        <div class="alert alert-primary" role="alert">
                            <h2>Rabatt verfügbar</h2> <hr>
                            <p>Jetzt schnell sein, solange der Vorrat reicht.</p>
                        </div>
                    </div>
                </div>-->
                    <div class="card shadow mb-5">
                        <div class="card-body" style="text-align: center;">
                            ...
                            <span class="svg-icon svg-icon-primary svg-icon-8x">
                                ...
                                <br><br>
                                Skylink-Game vServer
                                <br>
                                <hr>
                            </h3>
                            <span style="font-size: 110%;">
                                Hier findest du vorkonfigurierte vServer Pakete,
                                mit Skylink Game Anti DDoS Schutz
                                <br>

                                <br>
                                <br>

                                <a href="<?= $helper->url(); ?>order/vserver/game" class="btn btn-block btn-outline-primary mb-4">
                                    <i class="fas fa-share-square"></i> <b>Zu den Paketen</b>
                                </a>
                            </span>
                        </div>
