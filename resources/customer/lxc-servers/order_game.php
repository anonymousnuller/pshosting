...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    <?php if($user->sessionExists($_COOKIE['session_token'])){ ?>
        ...
        <div class="text-center" style="margin-top: 50px; margin-bottom: 50px;">
            <h1 style="font-size: 70px;">Game Anti <b style="color: darkblue;">DDoS</b> V-Server</h1>
            <hr style="width: 50%;">
            <h1>Miete dir jetzt Prepaid LXC V-Server mit OVH Game Anti DDoS Protection</h1>
            ...
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="alert alert-primary" role="alert">
                                ...
                                Unsere OVH Game LXC V-Server Pakete sind <b>reduziert!</b>
                                <br><br>
                                Dieser Rabatt gilt nur bis zum 01.05.2021 - 23:59 Uhr.
                            </div>
                        </div>
                    </div>
                </div>
                ...
                if ($SQL->rowCount() != 0) {
                    while ($row = $SQL -> fetch(PDO::FETCH_ASSOC)){
                        ...
                        </svg><!--end::Svg Icon--></span> Standort Deutschland (OVH) <i class="fas fa-check text-success"></i><br>
                        ...
                        <div class="card shadow mb-5">
                            <div class="card-body" style="text-align: center;">
                                <h4 style="font-style: bold;">
                                    Momentan sind leider keine OVH-Game V-Server verfügbar.
                                </h4>
                                <p style="font-size: 100%;">
                                    Wir sind bereits an der Nachbeschaffung, sodass wir dir schnellstmöglich wieder einen LXC V-Server anbieten können.
                                </p>
                            </div>
                        </div>
                    </div>
