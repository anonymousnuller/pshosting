            ...
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="alert alert-primary" role="alert">
                                ...
                                Unsere LXC V-Server Pakete sind um <b>-35% reduziert!</b>
                                <br><br>
                                Dieser Rabatt gilt nur bis zum 08.04.2021 - 23:59 Uhr.
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card shadow mb-5">
                        ...
                        </svg><!--end::Svg Icon--></span> <?= $row['disk']; ?>GB NVMe SSD Speicher<br>
                        ...
                        </svg><!--end::Svg Icon--></span> Standort OVH Deutschland <i class="fas fa-check text-success"></i><br>
                        ...
                        </svg><!--end::Svg Icon--></span> OVH DDoS-Schutz <i class="fas fa-check text-success"></i><br>
                        ...
                        <div class="card shadow mb-5">
                            <div class="card-body" style="text-align: center;">
                                <h4 style="font-style: bold;">
                                    Momentan sind leider keine LXC V-Server verfügbar.
                                </h4>
