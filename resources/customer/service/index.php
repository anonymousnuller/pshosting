...
$currPage = 'customer_Service Übersicht';
...
if(isset($_POST['saveCustomName'])){
    ...
    if(empty($error)){
        ...
        $SQL = $db->prepare("UPDATE `services` SET `custom_name` = :custom_name WHERE `id` = :id");
        ...
        <div id="kt_content_container" class="container-xxl">
            <div class="container">
                <div class="row">
                    ...
                    <?php
                    $SQL = $db->prepare("SELECT * FROM `services` WHERE `user_id` = :user_id AND `deleted_at` IS NULL ORDER BY `id` DESC");
                            ...
                            <div class="col-12 col-xl-3">
                                <div class="card text-center">
                                            ...
                                            <div class="col">
                                                <h3 class="mb-0">
                                                    ...
                                                    <?php if(is_null($row['custom_name'])){ ?>
                                                        <b>Service</b> #<?= $row['id']; ?> <span data-bs-toggle="tooltip" title="Eigenen Produkt-Namen setzen"><i style="cursor:pointer;" data-bs-toggle="modal" data-bs-target="#productModal<?= $row['id']; ?>" class="far fa-edit"></i></span>
                                                    <?php } else { ?>
                                                        <?= $helper->xssFix($row['custom_name']); ?> <span data-bs-toggle="tooltip" title="Eigenen Produkt-Namen setzen"><i style="cursor:pointer;" data-bs-toggle="modal" data-bs-target="#productModal<?= $row['id']; ?>" class="far fa-edit"></i></span>
                                                    <?php } ?>
                                                </h3>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-footer">
                                        <div class="row align-items-center text-center">
                                            <div class="col-md-6">
                                                <a href="<?= env('URL'); ?>manage/service/<?= $row['id']; ?>/" class="btn btn-block btn-outline-primary">
                                                    <b>Verwalten</b>
                                                </a>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <?php } else { ?>
                                                    <a href="<?= env('URL'); ?>renew/service/<?= $row['id']; ?>/" class="btn btn-block btn-outline-primary">
                                                        <b>Verlängern</b>
                                                    </a>
                                                <?php } ?>
                                            </div>
