...
$currPage = 'customer_Mein Profil verwalten';
...
if(isset($_POST['changePassword'])){
    ...
    if(!$user->verifyLogin($email, $_POST['current_password'])){
...
if(isset($_POST['changeEmail'])){
    ...
    if(empty($_POST['current_email'])){
        $error = 'Bitte gebe deine aktuelle E-Mail an';
    }
    if(empty($_POST['new_email'])){
        $error = 'Bitte gebe deine neue E-Mail an';
    }
    if(empty($_POST['new_email_repeat'])){
        $error = 'Bitte wiederhole deine neue E-Mail';
    }

    if(!$user->verifyLoginEmail($email, $_POST['new_email'])){
        $error = 'Deine aktuelle E-Mail stimmt nicht';
    }

    if($_POST['new_email'] != $_POST['new_email_repeat']){
        $error = 'Die neuen E-Mails müssen übereinstimmen';
    }
    ...
    if(empty($error)){
        ...
        $SQL -> execute(array(":email" => $email, ":id" => $userid));

        echo sendSuccess('Deine E-Mail wurde geändert');
...
if(isset($_POST['saveMailSettings'])){
    if(isset($_POST['mail_login_notify'])) {
        $mail_login_notify = 1;
    } else {
        $mail_login_notify = 0;
    }
    ...
    $SQL = $db->prepare("UPDATE `customers` SET `mail_login_notify` = :mail_login_notify, `mail_ticket` = :mail_ticket, `mail_runtime` = :mail_runtime, `mail_suspend` = :mail_suspend, `mail_order` = :mail_order WHERE `id` = :id");
    $SQL -> execute(array(":mail_login_notify" => $mail_login_notify, ":mail_ticket" => $mail_ticket, ":mail_runtime" => $mail_runtime, ":mail_suspend" => $mail_suspend, ":mail_order" => $mail_order, ":id" => $userid));
...
<div class="modal fade" id="emailModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">E-Mail ändern</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="post">
                <div class="modal-body">
                    ...
                    <label>Neue E-Mail Adresse wiederholen</label>
                    <input name="new_email_repeat" type="email" class="form-control">

                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-primary font-weight-bolder" data-dismiss="modal"><i class="fas fa-trash"></i> Abbrechen</button>
                    <button type="submit" name="changeEmail" class="btn btn-outline-success font-weight-bolder"><i class="fas fa-exchange-alt"></i> E-Mail ändern</button>
                </div>
            </form>
        </div>
    </div>
            ...
            <div class="d-flex flex-column flex-xl-row">
                        ...
                        <div class="card-body pt-15">
                            ...
                            <div class="d-flex flex-center flex-column mb-5">
                                ...
                                <div class="symbol symbol-150px symbol-circle mb-7">
                                    <img src="<?= $helper->imageUrl(); ?>logos/profile.jpg" alt="image" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Name-->
                                <?php
                                if(is_null($user->getDataById($userid, 'firstname')) || is_null($user->getDataById($userid, 'lastname'))) {
                                    $name = $user->getDataById($userid, 'username');
                                } else {
                                    $name = $user->getDataById($userid, 'firstname') . ' ' . $user->getDataById($userid, 'lastname');
                                } ?>
                                <a href="javascript:;" class="fs-3 text-gray-800 text-hover-primary fw-bolder mb-1">
                                    <?= $name; ?>
                                </a>
                                <!--end::Name-->
                                <!--begin::Email-->
                                <a href="javascript:;" class="fs-5 fw-bold text-muted text-hover-primary mb-6">
                                    <?= $email; ?>
                                </a>
                                <!--end::Email-->
                            </div>
                            ...
                            <div class="d-flex flex-stack fs-4 py-3">
                                <div class="fw-bolder">Du bist?</div>
                                <!--begin::Badge-->
                            ...
                            <div class="pb-5 fs-6">
                                ...
                                <div class="text-gray-600"><?= env('CUSTOMER_ID'); ?>-<?= $userid; ?></div>
                                <!--begin::Details item-->
                                <!--begin::Details item-->
                                <div class="fw-bolder mt-5">Deine E-Mail</div>
                                <div class="text-gray-600">
                                    <a href="javascript:;" class="text-gray-600 text-hover-primary"><?= $email; ?></a>
                                </div>
                                <!--begin::Details item-->
                                <!--begin::Details item-->
                                <div class="fw-bolder mt-5">Deine Anschrift</div>
                                <?php
                                if(!is_null($user->getDataById($userid, 'street')) || !empty($user->getDataById($userid, 'street'))) {
                                    $street_2 = $user->getDataById($userid, 'street');
                                    if(!is_null($user->getDataById($userid, 'number')) || !empty($user->getDataById($userid, 'number'))) {
                                        $number_2 = $user->getDataById($userid, 'number');
                                        if(!is_null($user->getDataById($userid, 'postcode')) || !empty($user->getDataById($userid, 'postcode'))) {
                                            $postcode_2 = $user->getDataById($userid, 'postcode');
                                            if(!is_null($user->getDataById($userid, 'city')) || !empty($user->getDataById($userid, 'city'))) {
                                                $city_2 = $user->getDataById($userid, 'city');
                                                if(!is_null($user->getDataById($userid, 'country')) || !empty($user->getDataById($userid, 'country'))) {
                                                    $country_2 = $user->getDataById($userid, 'country');
                                                } else {
                                                    $country_2 = 'keine Angabe gefunden';
                                                }
                                            } else {
                                                $city_2 = '-';
                                            }
                                ...
                                ?>
                                <div class="text-gray-600">
                                    <?= $street_2; ?> <?= $number_2 . '<br />'; ?>
                                    <?= $postcode_2; ?> <?= $city_2 . '<br />'; ?>
                                    <?= $country_2; ?>
                                </div>
                                <!--begin::Details item-->
                                <!--begin::Details item-->
                                <div class="fw-bolder mt-5">Sprache</div>
                ...
                <div class="flex-lg-row-fluid ms-lg-15">
                    ...
                    <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-8">
                        <!--begin:::Tab item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab" href="#kt_ecommerce_customer_overview">Übersicht</a>
                        </li>
                        <!--end:::Tab item-->
                        <!--begin:::Tab item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#kt_ecommerce_customer_general">Allgemeine Einstellungen</a>
                        </li>
                        <!--end:::Tab item-->
                        <!--begin:::Tab item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#kt_ecommerce_customer_restful_access">RESTful-API Zugang</a>
                        </li>
                        <!--end:::Tab item-->
                        <!--begin:::Tab item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#kt_ecommerce_customer_restful_logs">RESTful-API Logs</a>
                        </li>
                        <!--end:::Tab item-->
                    </ul>
                    <!--end:::Tabs-->
                                    ...
                                    <div class="card pt-4 h-md-100 mb-6 mb-md-0">
                                        ...
                                        <div class="card-header border-0">
                                            ...
                                            <div class="card-title">
                                                <h2 class="fw-bolder">German-Host Punkte</h2>
                                            </div>
                                            <!--end::Card title-->
                                        </div>
                                        <!--end::Card header-->
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="fw-bolder fs-2">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="ms-2">
                                                        0
                                                        <span class="text-muted fs-4 fw-bold">Punkte gesammelt</span>
                                                    </div>
                                                </div>
                                                <div class="fs-7 fw-normal text-muted">Sammle Punkte mit Aufladungen, Bestellungen etc. und löse die gegen etwas ein.</div>
                                            </div>
                                        </div>
                                        <!--end::Card body-->
                                    </div>
                                ...
                                <div class="col">
                                    ...
                                    <div class="card pt-4 h-md-100 mb-6 mb-md-0">
                                        ...
                                        <div class="card-header border-0">
                                            <!--begin::Card title-->
                                            <div class="card-title">
                                                <h2 class="fw-bolder">Deine Platzierung</h2>
                                            </div>
                                            <!--end::Card title-->
                                        </div>
                                        <!--end::Card header-->
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="fw-bolder fs-2">
                                                ...
                                                <div class="fs-7 fw-normal text-muted">Die Platzierung wird momentan noch an der Kunden-ID bzw. Registrierung ausgemacht.</div>
                                            </div>
                                        </div>
                                        <!--end::Card body-->
                                    </div>
                                                ...
                                                <div class="flex-equal me-5">
                                                    <table class="table table-flush fw-bold gy-1">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-gray-800">**** 5806</td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <div class="d-flex flex-wrap py-5">
                                                ...
                                                <div class="flex-equal me-5">
                                                    <table class="table table-flush fw-bold gy-1">
                                                        ...
                                                        <tr>
                                                            <td class="text-muted min-w-125px w-125px">Number</td>
                                                            <td class="text-gray-800">**** 3048</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-muted min-w-125px w-125px">Expires</td>
                                            ...
                                            <div class="d-flex flex-wrap py-5">
                                                ...
                                                <div class="flex-equal me-5">
                                                    <table class="table table-flush fw-bold gy-1">
                                                        ...
                                                        <tr>
                                                            <td class="text-muted min-w-125px w-125px">Number</td>
                                                            <td class="text-gray-800">**** 6986</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-muted min-w-125px w-125px">Expires</td>
